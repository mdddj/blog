...
import DynamicListWidget from "./all";
...
export default function Page() {
  ...
  const [{ loading, data }] = useAxios<ApiResponse<ResourcesCategory[]>>({
    url: groupListApi,
  });
  ...
  const isAllSelected = selectId === "all" || !selectId;
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="md:hidden overflow-x-auto pb-2">
            <div className="flex space-x-2 min-w-max">
              ...
              >
                <Link
                  className={`btn btn-sm ${isAllSelected ? "btn-primary" : "btn-ghost"}`}
                  to="/g/all"
                >
                  全部动态
                </Link>
          ...
          <div className="hidden md:block flex-none w-64">
            <div className="bg-base-100 rounded-2xl shadow-xl p-6">
              ...
              <ul className="menu rounded-box">
                ...
                >
                  <Link
                    className={`${isAllSelected ? "active bg-primary text-primary-content" : ""}`}
                    to="/g/all"
                  >
                    全部动态
                  </Link>
