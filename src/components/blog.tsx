...
const BlogCard: React.FC<{ blog: Blog }> = ({blog}) => {
    ...
    return (
        <div onClick={() => nav(`/detail/${blog.id}`)}
             className="card hover:border-l-2 hover:shadow-2xl hover:border-l-primary  cursor-pointer relative transition-transform duration-300  hover:transform hover:-translate-y-1 focus-within:border-green-500 focus-within:transform focus-within:-translate-y-1 focus-within:outline-none">
