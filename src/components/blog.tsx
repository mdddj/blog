...
const BlogCard: React.FC<{ blog: Blog }> = ({ blog }) => {
    ...
    return (
        <div onClick={() => nav(`/detail/${blog.id}`)}
            className="card shadow rounded-2xl hover:border-l-4 hover:border-l-primary  cursor-pointer relative transition-transform duration-300  hover:transform hover:-translate-y-3 focus-within:border-green-500 focus-within:transform focus-within:-translate-y-3 focus-within:outline-none">
